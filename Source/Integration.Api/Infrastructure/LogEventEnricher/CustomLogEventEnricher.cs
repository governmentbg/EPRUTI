namespace Integration.Api.Infrastructure.LogEventEnricher
{
    ...
    {
        private readonly Integration.Api.Models.Logger.LogEvent logData;
        private readonly IRequestContext requestContext;
        private readonly IPrincipal user;

        public CustomLogEventEnricher(Integration.Api.Models.Logger.LogEvent logData, IRequestContext requestContext, IPrincipal user)
        {
