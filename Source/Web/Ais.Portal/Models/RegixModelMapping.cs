namespace Ais.Portal.Models
{
    ...
    public class RegixModelMapping : IHaveCustomMappings
    {
        ...
        public void CreateMappings(IProfileExpression configuration)
        {
            configuration.CreateMap<PermanentAddressResponseType, Address>()
                ...
                .ForMember(d => d.Region, m => m.MapFrom(s => new Nomenclature { Code = s.CityAreaCode, Name = s.CityArea }))
            ...
            configuration.CreateMap<PersonDataResponseType, ClientUpsertModel>()
                ...
                .ForMember(d => d.FirstNames, m => m.MapFrom(s => new string[] { s.PersonNames.FirstName.ToString() }))
                .ForMember(d => d.SurNames, m => m.MapFrom(s => new string[] { s.PersonNames.SurName.ToString() }))
                .ForMember(d => d.FamilyNames, m => m.MapFrom(s => new string[] { s.PersonNames.FamilyName.ToString() }))
                .ForMember(d => d.FirstNamesLatin, m => m.MapFrom(s => new string[] { s.LatinNames.FirstName.ToString() }))
                .ForMember(d => d.SurNamesLatin, m => m.MapFrom(s => new string[] { s.LatinNames.SurName.ToString() }))
                .ForMember(d => d.FamilyNamesLatin, m => m.MapFrom(s => new string[] { s.LatinNames.FamilyName.ToString() }));
