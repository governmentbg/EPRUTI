namespace Ais.Portal.Components
{
    ...
    public class FooterMenuViewComponent : BaseMenuViewComponent
    {
        public FooterMenuViewComponent(
        ...
        public override async Task<IViewComponentResult> InvokeAsync()
        {
            ...
            var menuItems = this.GetPagesTree(pages?.Where(item => item.Locations?.Contains(LocationType.FooterMenu) == true), null);
