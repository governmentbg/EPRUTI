namespace Ais.Office.Areas.OutAdministrativeAct.Controllers
{
    ...
    [Authorize(Roles = UserRolesConstants.AALostEffectByAdminForPeriodByTypeArchivesSearch)]
    public class AdmActLostLegalEffectByAdministrationForPeriodByTypeArchivesController : SearchTableController<AdmActLostLegalEffectByAdministrationForPeriodByTypeArchivesQueryViewModel, AdmActLostLegalEffectByAdministrationForPeriodByTypeArchivesTableViewModel>
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AdmActLostLegalEffectByAdministrationForPeriodByTypeArchivesController"/> class.
        /// </summary>
        ...
        public AdmActLostLegalEffectByAdministrationForPeriodByTypeArchivesController(ILogger<SearchTableController<AdmActLostLegalEffectByAdministrationForPeriodByTypeArchivesQueryViewModel, AdmActLostLegalEffectByAdministrationForPeriodByTypeArchivesTableViewModel>> logger, IStringLocalizer localizer, ISessionStorageService sessionSessionStorageService, IOutAdmActService outAdmActService, IMapper mapper, IDataBaseContextManager<AisDbType> contextManager, IStorageService storageService, IAddressService addressService, INomenclatureService nomenclatureService)
            : base(logger, localizer, sessionSessionStorageService)
        {
            ...
            this.Options.TableHeaderText = this.Localizer["AALostEffectByAdminForPeriodByTypeArchivesSearch"];
            this.addressService = addressService;
            this.nomenclatureService = nomenclatureService;
        }

        public override Task<IActionResult> Index(AdmActLostLegalEffectByAdministrationForPeriodByTypeArchivesQueryViewModel query = null)
        {
            if (query == null || !ReflectionUtils.HasNonNullProperty(query))
            {
                query = new AdmActLostLegalEffectByAdministrationForPeriodByTypeArchivesQueryViewModel();
            }
        ...
        protected override async Task InitialQueryAsync(AdmActLostLegalEffectByAdministrationForPeriodByTypeArchivesQueryViewModel model)
        {
        ...
        protected override async Task<IEnumerable<AdmActLostLegalEffectByAdministrationForPeriodByTypeArchivesTableViewModel>> FindResultsAsync(AdmActLostLegalEffectByAdministrationForPeriodByTypeArchivesQueryViewModel query)
        {
            var dbQuery = this.mapper.Map<AdmActLostLegalEffectByAdministrationForPeriodByTypeArchivesQueryModel>(query);
            List<AdmActLostLegalEffectByAdministrationForPeriodByTypeArchivesTableModel> results;
            await using (await this.contextManager.NewConnectionAsync())
            {
                results = await this.outAdmActService.SearchAdmActLostLegalEffectByAdministrationForPeriodByTypeArchivesAsync(dbQuery);
            }

            return this.mapper.Map<IEnumerable<AdmActLostLegalEffectByAdministrationForPeriodByTypeArchivesTableViewModel>>(results);
        }
    }
}
