namespace Ais.Office.Areas.OutAdministrativeAct.Controllers
{
    ...
    /// <summary>
    /// Class AdmActIssuedByAdministrationForPeriodByTypeReportsController.
    /// Implements the <see cref="Ais.Table.Mvc.Controllers.SearchTableController{AdmActIssuedByAdministrationForPeriodByTypeReportsQueryViewModel, AdmActIssuedByAdministrationForPeriodByTypeReportsTableViewModel}" />
    /// </summary>
    /// <seealso cref="Ais.Table.Mvc.Controllers.SearchTableController{AdmActIssuedByAdministrationForPeriodByTypeReportsQueryViewModel, AdmActIssuedByAdministrationForPeriodByTypeReportsTableViewModel}" />
    [Area("OutAdministrativeAct")]
    [Authorize(Roles = UserRolesConstants.AAIssuedByAdminForPeriodByTypeReportsSearch)]
    public class AdmActIssuedByAdministrationForPeriodByTypeReportsController : SearchTableController<AdmActIssuedByAdministrationForPeriodByTypeReportsQueryViewModel, AdmActIssuedByAdministrationForPeriodByTypeReportsTableViewModel>
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AdmActIssuedByAdministrationForPeriodByTypeReportsController"/> class.
        /// </summary>
            ...
            : base(logger, localizer, sessionSessionStorageService)
        {
            ...
            this.Options.TableHeaderText = this.Localizer["AAIssuedByAdminForPeriodByTypeReportsSearch"];
            this.addressService = addressService;
            this.nomenclatureService = nomenclatureService;
        }

        public override Task<IActionResult> Index(AdmActIssuedByAdministrationForPeriodByTypeReportsQueryViewModel query = null)
        {
            if (query == null || !ReflectionUtils.HasNonNullProperty(query))
            {
                query = new AdmActIssuedByAdministrationForPeriodByTypeReportsQueryViewModel();
            }
        ...
        protected override async Task InitialQueryAsync(AdmActIssuedByAdministrationForPeriodByTypeReportsQueryViewModel model)
        {
        ...
        protected override async Task<IEnumerable<AdmActIssuedByAdministrationForPeriodByTypeReportsTableViewModel>> FindResultsAsync(AdmActIssuedByAdministrationForPeriodByTypeReportsQueryViewModel query)
        {
            var dbQuery = this.mapper.Map<AdmActIssuedByAdministrationForPeriodByTypeReportsQueryModel>(query);
            List<AdmActIssuedByAdministrationForPeriodByTypeReportsTableModel> results;
            await using (await this.contextManager.NewConnectionAsync())
            {
                results = await this.outAdmActService.SearchAdmActIssuedByAdministrationForPeriodByTypeReportsAsync(dbQuery);
            }

            return this.mapper.Map<IEnumerable<AdmActIssuedByAdministrationForPeriodByTypeReportsTableViewModel>>(results);
        }
    }
}
