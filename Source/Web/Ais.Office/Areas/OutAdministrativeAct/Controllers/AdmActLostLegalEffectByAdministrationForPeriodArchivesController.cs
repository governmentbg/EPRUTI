namespace Ais.Office.Areas.OutAdministrativeAct.Controllers
{
    ...
    /// <summary>
    /// Class AdmActLostLegalEffectByAdministrationForPeriodArchivesController.
    /// Implements the <see cref="Ais.Table.Mvc.Controllers.SearchTableController{AdmActLostLegalEffectByAdministrationForPeriodArchivesQueryViewModel, AdmActLostLegalEffectByAdministrationForPeriodArchivesTableViewModel}" />
    /// </summary>
    /// <seealso cref="Ais.Table.Mvc.Controllers.SearchTableController{AdmActLostLegalEffectByAdministrationForPeriodArchivesQueryViewModel, AdmActLostLegalEffectByAdministrationForPeriodArchivesTableViewModel}" />
    [Area("OutAdministrativeAct")]
    [Authorize(Roles = UserRolesConstants.AALostEffectByAdminForPeriodArchivesSearch)]
    public class AdmActLostLegalEffectByAdministrationForPeriodArchivesController : SearchTableController<AdmActLostLegalEffectByAdministrationForPeriodArchivesQueryViewModel, AdmActLostLegalEffectByAdministrationForPeriodArchivesTableViewModel>
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AdmActLostLegalEffectByAdministrationForPeriodArchivesController"/> class.
        /// </summary>
        ...
        public AdmActLostLegalEffectByAdministrationForPeriodArchivesController(ILogger<SearchTableController<AdmActLostLegalEffectByAdministrationForPeriodArchivesQueryViewModel, AdmActLostLegalEffectByAdministrationForPeriodArchivesTableViewModel>> logger, IStringLocalizer localizer, ISessionStorageService sessionSessionStorageService, IOutAdmActService outAdmActService, IMapper mapper, IDataBaseContextManager<AisDbType> contextManager, IStorageService storageService, IAddressService addressService, INomenclatureService nomenclatureService)
            : base(logger, localizer, sessionSessionStorageService)
        {
            ...
            this.Options.TableHeaderText = this.Localizer["AALostEffectByAdminForPeriodArchivesSearch"];
            this.addressService = addressService;
            this.nomenclatureService = nomenclatureService;
        }

        public override Task<IActionResult> Index(AdmActLostLegalEffectByAdministrationForPeriodArchivesQueryViewModel query = null)
        {
            if (query == null || !ReflectionUtils.HasNonNullProperty(query))
            {
                query = new AdmActLostLegalEffectByAdministrationForPeriodArchivesQueryViewModel();
            }
        ...
        protected override async Task InitialQueryAsync(AdmActLostLegalEffectByAdministrationForPeriodArchivesQueryViewModel model)
        {
        ...
        protected override async Task<IEnumerable<AdmActLostLegalEffectByAdministrationForPeriodArchivesTableViewModel>> FindResultsAsync(AdmActLostLegalEffectByAdministrationForPeriodArchivesQueryViewModel query)
        {
            var dbQuery = this.mapper.Map<AdmActLostLegalEffectByAdministrationForPeriodArchivesQueryModel>(query);
            List<AdmActLostLegalEffectByAdministrationForPeriodArchivesTableModel> results;
            await using (await this.contextManager.NewConnectionAsync())
            {
                results = await this.outAdmActService.SearchAdmActLostLegalEffectByAdministrationForPeriodArchivesAsync(dbQuery);
            }

            return this.mapper.Map<IEnumerable<AdmActLostLegalEffectByAdministrationForPeriodArchivesTableViewModel>>(results);
        }
    }
}
